          ...
          <div className="my-8 w-full md:w-1/2">
            ...
            <div className="address flex flex-col justify-center my-3 md:my-5">
              <div className="flex items-center mb-5">
                <img className="w-10 mr-2" src={tent} alt="" />
            ...
            <div className="flex items-center mr-8 mb-2 md:mb-0 text-sm md:text-base">
              <img className="w-4 md:w-5 mr-3" src={phone} alt="" />
          ...
          <div className="w-full md:w-1/2 max-w-md my-8">
            ...
            <form onSubmit={formik.handleSubmit}>
              ...
              <button
                ...
                className="contact-btn w-40 text-sm md:text-md h-12 md:h-16 mt-4 rounded-lg team-btn bg-transparent border-solid border-2 uppercase rounded-sm font-semibold"
              >
                Send message
              </button>
            </form>
